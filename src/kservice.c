...
#ifdef RT_USING_HOOK
void (*rt_malloc_hook)(void **ptr, rt_size_t size);
void (*rt_realloc_entry_hook)(void **ptr, rt_size_t size);
void (*rt_realloc_exit_hook)(void **ptr, rt_size_t size);
void (*rt_free_hook)(void **ptr);
...
{
    volatile  rt_ubase_t begin_align = RT_ALIGN((rt_ubase_t)begin_addr, RT_ALIGN_SIZE);
    volatile  rt_ubase_t end_align   = RT_ALIGN_DOWN((rt_ubase_t)end_addr, RT_ALIGN_SIZE);
